...
cp $BASEDIR/fail2ban-config/action.d/ransom2ban-mail-it.conf /etc/fail2ban/action.d/
mv /etc/fail2ban/action.d/ransom2ban-mail-it.conf /etc/fail2ban/action.d/ransom2ban-mail.conf

cp -f $BASEDIR/rsyslog-config/00-samba_audit.conf /etc/rsyslog.d/
